...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-light-bg font-body">
      {/* Page Header */}
      <div className="bg-dark-bg py-20 px-4 text-center">
        <p className="text-golf-gold font-body tracking-[0.3em] text-sm uppercase mb-3">
          Hubungi Kami
        </p>
        <h1 className="font-heading text-4xl md:text-5xl text-white mb-4">
          Contact Us
        </h1>
        <div className="w-16 h-0.5 bg-golf-gold mx-auto" />
      </div>
